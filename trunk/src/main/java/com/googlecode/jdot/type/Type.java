...
import com.googlecode.jdot.mapper.RegexpNameMapper;
...
public class Type implements Cloneable {
    ...
    private Set<String> getTypeMapperClassNames(com.googlecode.jdot.annotation.TypeMapping mapperAnnotation) {
    ...
    private void populateTypeMappers(TypeElement typeElement) {
        ...
        typeMapperClassNames.addAll(getTypeMapperClassNames(typeElement
                .getAnnotation(com.googlecode.jdot.annotation.TypeMapping.class)));
        typeMapperClassNames.addAll(getTypeMapperClassNames(typeElement.getEnclosingElement().getAnnotation(
                com.googlecode.jdot.annotation.TypeMapping.class)));
